...
// unlock_h_scenes.js
var require_unlock_h_scenes = __commonJS({
  "unlock_h_scenes.js"() {
    init_node_globals();
    init_dist();
    Il2Cpp.perform(() => {
      ...
      try {
        ...
        console.log(
          "[OK] Chi\u1EBFn l\u01B0\u1EE3c 1: \u0110\xE3 hook th\xE0nh c\xF4ng v\xE0o vi\u1EC7c ki\u1EC3m tra \u0111\u1ED9 th\xE2n m\u1EADt."
        );
      } catch (err) {
...
export default require_unlock_h_scenes();
