...
// no-reload.js
var require_no_reload = __commonJS({
  "no-reload.js"() {
    init_node_globals();
    init_dist();
    var NO_COOLDOWN_ENABLED = true;
    var DEBUG_MODE = true;
    var FORCE_PLACEMENT = true;
    Il2Cpp.perform(() => {
      ...
      try {
            ...
            onEnter(args) {
              ...
              try {
                ...
                if (originalPercent < 1) {
                  if (DEBUG_MODE) {
                    console.log(
                      `[*] Instant Use Plant [ID:${unitId}]: Cooldown ${(originalPercent * 100).toFixed(1)}% -> 100%`
                    );
                  }
                  const newBuffer = Memory.alloc(4);
                  newBuffer.writeFloat(1);
        ...
        console.log("[INFO] ========================================");
        console.log("[INFO] \u{1F331} NO COOLDOWN MOD ACTIVE \u{1F331}");
        console.log("[INFO] ========================================");
...
export default require_no_reload();
