...
// hack-time.js
var require_hack_time = __commonJS({
  "hack-time.js"() {
    init_node_globals();
    init_dist();
    var GAME_SPEED_MULTIPLIER = 5;
    Il2Cpp.perform(() => {
      ...
      try {
        ...
        const InGameController = Il2Cpp.domain.assembly("Assembly-CSharp").image.class("InGameController");
        ...
        try {
          Il2Cpp.domain.assembly("UnityEngine.CoreModule").image.class("UnityEngine.Time").method("set_timeScale", 1).invoke(GAME_SPEED_MULTIPLIER);
...
export default require_hack_time();
