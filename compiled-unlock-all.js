...
// unlock-all.js
var require_unlock_all = __commonJS({
  "unlock-all.js"() {
    init_node_globals();
    init_dist();
    console.log(
    ...
    Il2Cpp.perform(() => {
          ...
          if (!featuresUnlocked) {
            ...
            try {
              ...
              for (let i = 0; i < craftCount; i++) {
                ...
                playerCraftElement.field("lv").value = ObscuredInt.method("op_Implicit").invoke(maxLevel);
                maxedCount++;
              }
      ...
      try {
        ...
        console.error("[ERROR] L\u1ED7i \u1EDF c\xE1c ch\u1EE9c n\u0103ng ch\xEDnh:", error.stack);
      }
      try {
        ...
        onEnableSkinMethod.implementation = function() {
          if (!skinsAdded) {
            ...
            try {
              ...
              console.error("[ERROR] L\u1ED7i khi \u0111ang th\xEAm skin:", e.stack);
            }
          }
...
export default require_unlock_all();
